...
- Public room snapshots contain no role information.
...
The event interfaces describe the target V3 protocol. Room handlers are implemented in the following migration step.
