...
export const ROLE_CONTENT: Readonly<Record<string, RoleContent | undefined>> = {
  ...
  "enfant-de-choeur": {
    ...
    info: "Essayer de garder votre rôle secret. Votre mort pénaliserait le village. Essayez de vous faire passer pour un personnage gênant pour le Loup Garou Ultime tel que l'Ancien ou l'Ange.",
  },
  "loup-blanc": {
